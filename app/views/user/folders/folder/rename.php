<div class="sectionTitle">Renombrar Carpeta</div>

<?php \helpers\messages::comprobarErrores(); ?>

<div class="folders_showName"><i class="fa fa-folder"></i> <?php echo $folder['decrypted'] ?></div>

<form method="post" action="<?php echo DIR; ?>post/rename/folder" autocomplete="off">

	<center>

		<div class="wrapper">
			<div class="inputIcon"><i class="fa fa-folder"></i></div>
			<input type="text" name="nombre" value="<?php echo $folder['actualName'] ?>" placeholder="Nombre de la Carpeta"/>
		</div>
